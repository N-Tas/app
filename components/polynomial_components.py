...
# Didn't use inheritance or new model with id and result,
# because of the order of return
# -------------------------------------------------------------------   
...
class Bindigns():
    ...
    def __init__(self,c_lib_name, sub_dir = ""):
        libname = pathlib.Path().absolute() / sub_dir / c_lib_name
